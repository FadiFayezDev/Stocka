    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BrandMemberships", x => new { x.BrandId, x.UserId });
                    table.ForeignKey(
                        name: "FK_BrandMemberships_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_BrandMemberships_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BrandMemberships_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                    BrandId = table.Column<Guid>(type: "uuid", nullable: false),
                    EntryDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpenseDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false, defaultValueSql: "NOW()"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_JournalEntryLines_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Batches_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WarehouseBatches_Brands_BrandId",
                        column: x => x.BrandId,
                        principalTable: "Brands",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BrandMemberships_ApplicationUserId",
                table: "BrandMemberships",
                column: "ApplicationUserId");

            migrationBuilder.CreateIndex(
                name: "IX_BrandMemberships_UserId",
                table: "BrandMemberships",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpenseCategories_BrandId",
                table: "ExpenseCategories",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "IX_Expenses_BrandId",
                table: "Expenses",
                column: "BrandId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntries_BrandId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JournalEntryLines_BrandId",
                table: "JournalEntryLines",
                column: "BrandId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductCategories_BrandId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseBatches_BatchId",
                table: "WarehouseBatches",
                column: "BatchId");

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseBatches_BrandId",
                table: "WarehouseBatches",
                column: "BrandId");

            migrationBuilder.CreateIndex(
                name: "UQ_WarehouseBatches_WarehouseId_BatchId",
                table: "WarehouseBatches",
