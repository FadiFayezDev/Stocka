...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260224072944_AddBranchScopeToTransactionalAggregates")]
    partial class AddBranchScopeToTransactionalAggregates
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Domain.Entities.Core.Employee", b =>
                {
                    ...
                    b.HasIndex("BrandId", "BranchId")
                        .HasDatabaseName("ix_employees_brand_id_branch_id");
            ...
            modelBuilder.Entity("Domain.Entities.Expenses.Expense", b =>
                {
                    ...
                    b.HasIndex("BrandId", "BranchId", "ExpenseDate")
                        .HasDatabaseName("ix_expenses_brand_id_branch_id_expense_date");
            ...
            modelBuilder.Entity("Domain.Entities.Orders.Order", b =>
                {
                    ...
                    b.HasIndex("BrandId", "BranchId", "OrderDate")
                        .HasDatabaseName("ix_orders_brand_id_branch_id_order_date");
            ...
            modelBuilder.Entity("Domain.Entities.Products.WarehouseBranch", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_warehouse_branch");

                    b.HasIndex("BrandId")
                        .HasDatabaseName("ix_warehouse_branch_brand_id");

                    b.HasIndex("WarehouseId")
                        .HasDatabaseName("ix_warehouse_branch_warehouse_id");

                    b.HasIndex("BranchId", "WarehouseId")
                        .IsUnique()
                        .HasDatabaseName("ix_warehouse_branch_branch_id_warehouse_id");

                    b.ToTable("warehouse_branch", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Purchasing.Purchase", b =>
                {
                    ...
                    b.HasIndex("BranchId")
                        .HasDatabaseName("ix_purchases_branch_id");

                    b.HasIndex("SupplierId")
                        .HasDatabaseName("ix_purchases_supplier_id");

                    b.HasIndex("BrandId", "BranchId", "PurchaseDate")
                        .HasDatabaseName("ix_purchases_brand_id_branch_id_purchase_date");
