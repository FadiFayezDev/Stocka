...
namespace Infrastructure.Repositories.Queries
{
    public class StockMovementQueryRepository : QueryRepository, IStockMovementQueryRepository
    {
        ...
        {
            var query = $"SELECT id, product_id AS ProductId, warehouse_id AS WarehouseId, batch_id AS BatchId, movement_type AS MovementType, reference_type AS ReferenceType, quantity AS Quantity, created_at AS CreatedAt FROM {TableStockMovements} WHERE id = @Id";
        ...
        {
            var query = $"SELECT id, product_id AS ProductId, warehouse_id AS WarehouseId, batch_id AS BatchId, movement_type AS MovementType, reference_type AS ReferenceType, quantity AS Quantity, created_at AS CreatedAt FROM {TableStockMovements}";
        ...
        {
            var query = $@"SELECT sm.id, sm.product_id AS ProductId, sm.warehouse_id AS WarehouseId, sm.batch_id AS BatchId, sm.movement_type AS MovementType, sm.reference_type AS ReferenceType, sm.quantity AS Quantity, sm.created_at AS CreatedAt 
