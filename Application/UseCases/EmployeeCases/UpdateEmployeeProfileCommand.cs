...
{
    public class UpdateEmployeeProfileCommand : IRequest<Response<EmployeeDto>>
    {
    ...
    public class UpdateEmployeeProfileCommandHandler : BaseHandler<IEmployeeCommandRepository>, IRequestHandler<UpdateEmployeeProfileCommand, Response<EmployeeDto>>
    {
        ...
        public async Task<Response<EmployeeDto>> Handle(UpdateEmployeeProfileCommand request, CancellationToken cancellationToken)
        {
