...
{
    public class PartialUpdateWarehouseCommand : IRequest<WarehouseDto>
    {
    ...
    public class PartialUpdateWarehouseCommandHandler : IRequestHandler<PartialUpdateWarehouseCommand, WarehouseDto>
    {
        ...
        public PartialUpdateWarehouseCommandHandler(
        ...
        public async Task<WarehouseDto> Handle(PartialUpdateWarehouseCommand request, CancellationToken cancellationToken)
        {
            try
            {
