...
{
    public class RegisterWarehouseCommand : IRequest<WarehouseDto>
    {
    ...
    public class RegisterWarehouseCommandHandler : IRequestHandler<RegisterWarehouseCommand, WarehouseDto>
    {
        ...
        public RegisterWarehouseCommandHandler(
        ...
        public async Task<WarehouseDto> Handle(RegisterWarehouseCommand request, CancellationToken cancellationToken)
        {
