...
{
    public class RegisterBranchCommand : IRequest<BranchDto>
    {
        public string Name { get; set; } = null!;
    }

    public class RegisterBranchCommandHanlder : IRequestHandler<RegisterBranchCommand, BranchDto>
    {
        ...
        public RegisterBranchCommandHanlder(
        ...
        public async Task<BranchDto> Handle(RegisterBranchCommand request, CancellationToken cancellationToken)
        {
