...
{
    public class CreateCategoryCommand : IRequest<ProductCategoryDto>
    {
        public string Name { get; set; } = null!;
    }

    public class CreateCategoryCommandHanlder : IRequestHandler<CreateCategoryCommand, ProductCategoryDto>
    {
        ...
        public async Task<ProductCategoryDto> Handle(CreateCategoryCommand request, CancellationToken cancellationToken)
        {
