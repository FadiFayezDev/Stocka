...
namespace Application.Features.Commands.JournalEntryLine.Delete
{
    ...
    {
        public DeleteJournalEntryLineCommandHandler(IMapper mapper,IJournalEntryLineCommandRepository repository, IUnitOfWork unitOfWork)
        ...
        public async Task<Response<bool>> Handle(DeleteJournalEntryLineCommand request, CancellationToken cancellationToken)
        {
            ...
            if (existing == null)
                throw new BusinessException("Journal entry line not found");
