...
{
    public class PartialUpdateProductCommand : IRequest<ProductDto>
    {
    ...
    public class PartialUpdateProductCommandHandler : IRequestHandler<PartialUpdateProductCommand, ProductDto>
    {
        ...
        public PartialUpdateProductCommandHandler(IProductCommandRepository branchCommand, IMapper mapper, IUnitOfWork unitOfWork, IStorageService storageService, IProductQueryRepository productQuery)
        {
        ...
        public async Task<ProductDto> Handle(PartialUpdateProductCommand request, CancellationToken cancellationToken)
        {
